...
from .views import *
from userapp.views import PetChatAPIView
...
urlpatterns = [
    ...
    path('delete_pet/', DeletePetView.as_view(), name='delete_pet'),
    ...
    path('appointments_detail/', BookingDetailsAPIView.as_view(), name='appointment_detail'),
    path('reorder/', ReorderAPIView.as_view(), name='reorder'),
    path("chat/", PetChatAPIView.as_view(), name="pet_chat_api"),
    path('recommendation/',PetFoodRecommendationAPIView.as_view(),name='recommendation'),
